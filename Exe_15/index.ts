...
//Step 1
let guestNames:string[] = ["Ali", "Nosheen","Ahmed", "Fiza", "Kehkashan", "suggand"];
//                           0        1         2       3        4           5


// person not coming

let guestNotComing1:any = "kehkashan";
...
for( let guestName of guestNames) { console.log(`Dear ${guestName}, \n You are invited for dinner on saturday please join us. \n Thank you`)};
